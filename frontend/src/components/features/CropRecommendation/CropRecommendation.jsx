        ...
        if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition(async (position) => {
                ...
                try {
                    ...
                    console.log('%c 🌍 GEO DATA FETCHED:', 'color: cyan; font-weight: bold;', geoData);
                    ...
                    console.log('%c 🔴 WEATHER DATA FETCHED:', 'color: red; font-weight: bold; font-size: 14px;', weatherData);
