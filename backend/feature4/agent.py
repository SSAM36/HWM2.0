...
def create_application(state: AgentState) -> Dict:
    ...
    **Land Size:** {profile.get('land_size', 'Not specified')} acres
    ...
    🔗 {selected_scheme.get('application_url', 'https://agrimachinery.nic.in/') if selected_scheme else 'https://agrimachinery.nic.in/'}
    ...
    📞 **Helpline:** 1800-180-1551 (Kisan Call Center)"""
        ...
        response = f"""⚠️ **Profile Information Needed**
...
def auto_apply_node(state: AgentState) -> Dict:
    ...
    **What I can help with:**
    ...
    Would you like me to search for government schemes for you?"""
        ...
        if not fill_result.get("can_submit"):
            ...
            response = f"""⚠️ **Additional Information Needed**
    ...
    **Already Filled:**
    ...
    🔗 {scheme_info.get('application_url', 'https://agrimachinery.nic.in/')}
    ...
    **Alternative:** You can apply manually at:
    🔗 {scheme_info.get('application_url', submit_result.get('fallback_url', 'https://agrimachinery.nic.in/'))}
